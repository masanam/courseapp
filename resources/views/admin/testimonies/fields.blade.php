...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('fullname', null, ['class' => 'form-control','maxlength' => 100,'maxlength' => 100,'maxlength' => 100]) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    <textarea name="description" class="form-control my-editor">{!! old('description', isset( $testimony) ?  $testimony->description : '') !!}</textarea>
</div>
