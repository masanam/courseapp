...
@push('plugin-styles')
  <!-- {!! Html::style('/stara/assets/plugins/plugin.css') !!} -->
@endpush
        ...
        <div class="d-flex flex-md-column flex-xl-row flex-wrap justify-content-between align-items-md-center justify-content-xl-between">
          ...
          <div class="float-right">
            ...
            <div class="fluid-container">
              <h3 class="font-weight-medium text-right mb-0">Rp. 65,650</h3>
            </div>
          </div>
        </div>
  ...
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
          <i class="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> Course-wise sales </p>
      </div>
    </div>
  </div>
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
          <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Weekly Course </p>
      </div>
    </div>
  </div>
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
    <div class="card card-statistics">
      <div class="card-body">
        ...
        <p class="text-muted mt-3 mb-0 text-left text-md-center text-xl-left">
          <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Course-wise sales </p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
          <h2 class="card-title mb-0">Course Analysis</h2>
          <div class="wrapper d-flex">
            <div class="d-flex align-items-center mr-3">
              <span class="dot-indicator bg-success"></span>
              <p class="mb-0 ml-2 text-muted">Course</p>
            </div>
      ...
      <div class="card-body">
        ...
        <div class="event border-bottom py-3">
          ...
          <div class="d-flex align-items-center">
            ...
            <small class="text-muted ml-2">Jakarta, INA</small>
            <div class="image-grouped ml-auto">
              <img src="{{ url('stara/assets/images/faces/face10.jpg') }}" alt="profile image">
              <img src="{{ url('stara/assets/images/faces/face13.jpg') }}" alt="profile image"> </div>
          </div>
        </div>
        <div class="event py-3 border-bottom">
          ...
          <div class="d-flex align-items-center">
            ...
            <small class="text-muted ml-2">Jakarta, INA</small>
            <div class="image-grouped ml-auto">
              <img src="{{ url('stara/assets/images/faces/face20.jpg') }}" alt="profile image">
              <img src="{{ url('stara/assets/images/faces/face17.jpg') }}" alt="profile image">
              <img src="{{ url('stara/assets/images/faces/face14.jpg') }}" alt="profile image"> </div>
          </div>
        </div>
        <div class="event py-3">
          ...
          <div class="d-flex align-items-center">
            ...
            <small class="text-muted ml-2">Jakarta, INA</small>
            <div class="image-grouped ml-auto">
              <img src="{{ url('stara/assets/images/faces/face21.jpg') }}" alt="profile image">
              <img src="{{ url('stara/assets/images/faces/face16.jpg') }}" alt="profile image"> </div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card card-revenue">
          <div class="card-body d-flex align-items-center">
            <div class="d-flex flex-grow">
              <div class="mr-auto">
                <p class="highlight-text mb-0 text-white"> Rp. 168.90 </p>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-7">
            ...
            <h1 class="font-weight-medium mb-0">Rp. 5998</h1>
      ...
      <div class="card-body">
        ...
        <div class="fluid-container">
          <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{ url('stara/assets/images/faces/face1.jpg') }}" alt="profile image"> </div>
          ...
          <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{ url('stara/assets/images/faces/face2.jpg') }}" alt="profile image"> </div>
            <div class="ticket-details col-md-9">
              <div class="d-flex">
          ...
          <div class="row ticket-card mt-3">
            <div class="col-md-1">
              <img class="img-sm rounded-circle mb-4 mb-md-0 d-block mx-md-auto" src="{{ url('stara/assets/images/faces/face3.jpg') }}" alt="profile image"> </div>
            <div class="ticket-details col-md-9">
              <div class="d-flex">
...
@push('plugin-scripts')
  {!! Html::script('/stara/assets/plugins/chartjs/chart.min.js') !!}
  {!! Html::script('/stara/assets/plugins/jquery-sparkline/jquery.sparkline.min.js') !!}
@endpush

@push('custom-scripts')
  {!! Html::script('/stara/assets/js/dashboard.js') !!}
@endpush